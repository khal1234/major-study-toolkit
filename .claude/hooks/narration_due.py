...
# ★ 도구 폴더 이름은 프로젝트마다 다르다(나루 `도구/` · 여기 `tools/`). 하나로 박으면
#   가져간 쪽에서 조용히 죽는다 — `commit.py` 가 `ROOT/"tools"` 를 박아 나루에서 네 번
#   되살아난 그 부류다(나루 `변경일지.md` 2026-08-14·17·20).
# ★★ **이 리포는 컨테이너 루트에서도 돈다** (전공정리 이식 2026-08-25). 나루 판본은
