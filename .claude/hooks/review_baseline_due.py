# -*- coding: utf-8 -*-
"""사용자가 「봤다」고 말한 턴에 **기준선이 안 밀린 챕터**를 한 줄로 알린다.

열린 날 2026-08-18. 사용자: [사용자 발화 인용 생략] — 같은 요청이 세 번째다.

★★ **왜 문서로는 안 닫혔나.** `AGENTS.md` 는 이미 [사용자 발화 인용 생략] 고
  적고 있고 에이전트 메모리에도 [사용자 발화 인용 생략] 가 있다. 그런데 둘 다
