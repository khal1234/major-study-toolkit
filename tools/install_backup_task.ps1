...
#
# 왜 만들었나 (2026-08-06, 사용자 지적): *"백업은 근데 내가 지시해야 하는거야?
# 이거 스케쥴러로 하게 한다 하지 않았나."* — 확인해 보니 **안 걸려 있었다.**
# `backup_bundle.py` 첫 줄에 인용된 원래 요청이 *"주기적인 백업 시스템"* 인데,
...
#   AGENTS 「알려진 함정」의 *"Windows 기본은 cp949라 명시하지 않으면 한글이 조용히 깨진다"* 와
